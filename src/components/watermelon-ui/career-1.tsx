...
const defaultJobs: Career1Job[] = [
  {
    ...
    description:
      "Lead cross-functional squads, set technical direction, and help engineers grow.",
  ...
  },
  {
    ...
    description:
      "Craft delightful, performant interfaces used by thousands of teams worldwide.",
    department: "Engineering",
    location: "Hybrid",
    type: "Full-time",
    href: "#",
  ...
  },
  {
    ...
    description:
      "Build models that power intelligent features and surface actionable insights.",
    department: "Engineering",
    location: "Remote",
    type: "Full-time",
    href: "#",
  },
  {
    ...
    description:
      "Drive roadmap strategy, synthesise user feedback, and ship products people love.",
    department: "Product",
    location: "Hybrid",
    type: "Full-time",
    href: "#",
  },
  {
    ...
    description:
      "Experiment relentlessly across channels to accelerate acquisition and retention.",
    department: "Growth",
    location: "Remote",
    type: "Full-time",
    href: "#",
...
export default function Career1({
  ...
  const countByDept = (value: string) =>
    value === "all"
      ? jobs.length
      : jobs.filter((j) => j.department === value).length;
          ...
          {filteredJobs.length > 0 ? (
            ...
            <div className="flex flex-col items-center gap-3 py-14 text-center">
              ...
              <p className="max-w-xs text-xs text-muted-foreground">
                We don't have any open roles in this department at the moment.
                Check back soon!
              </p>
            </div>
          )}
