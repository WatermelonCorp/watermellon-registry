...
const BentoCard = ({
  ...
  <Card
    className={cn(
      "group relative min-h-[340px] cursor-pointer overflow-hidden rounded-xl border  p-0 border-white/10 bg-white/5",
      className
    )}
  >
    ...
    <CardFooter className="z-10 flex flex-col items-center justify-center gap-2 pb-4 text-center bg-transparent border-none">
      ...
      <p className="mx-auto max-w-[280px] text-md leading-tight text-neutral-600">
        {description}
      </p>
    </CardFooter>
  </Card>
...
const GlowingOrb = ({
  ...
  >
    ...
    <div className="absolute h-26 w-26 rounded-full  shadow-lgbg-black" />
    ...
    <div className="grid grid-cols-6 gap-2 [mask-image:radial-gradient(ellipse_at_center,black_20%,transparent_80%)]">
      {Array(18)
        ...
        .map((_, i) => (
          <div
            key={i}
            className="rounded-sm bg-gradient-to-b  p-[1.5px] shadow-[0_0_4px_rgba(0,0,0,0.5)] from-white/20 dark:to-white/5"
          >
...
export default function BentoGrid8() {
  return (
    <div className="min-h-screen  p-6 font-sans md:p-12 bg-black">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <BentoCard
          ...
          description="AI-distilled insights, ready to share. Elevate your voice in any conversation."
        >
          <div className="relative w-full max-w-[200px]">
            <div className="mask-b-blur-xl rounded-xl border  mask-b-from-0% mask-b-to-100% p-4 border-white/10 bg-white/5">
            ...
            <div className="absolute -bottom-6 left-1/2 z-20 -translate-x-1/2">
              <div className="relative rounded-full p-1 shadow-[inset__0px_0px_4px_0px_rgba(255,255,255,0.5)]">
                ...
                <div className="absolute -right-2 -bottom-2">
                  <ArrowIcon />
                  <div className="absolute -right-12 rounded-tr-2xl rounded-b-2xl bg-gradient-to-b from-cyan-400 to-cyan-400/70 px-4 py-1 text-[10px] font-bold text-black">
                    Kyle
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="relative flex items-center justify-center p-8">
      <div className="relative inline-flex items-center justify-center">
        <button className="relative z-10 rounded-full border-[8px] border-neutral-950 bg-[#222325] px-16 py-3 text-xl text-neutral-300 dark:shadow-[inset_2px_2px_8px_rgba(0,0,0,0.4),inset_1px_1px_1px_rgba(255,255,255,0.2)]">
          Get info
        </button>
      </div>
    </div>
        ...
        {loopItems.map((item, i) => (
          <div
            ...
            className={cn(
              ...
              item === "Designer"
                ? " bg-gradient-to-r from-blue-600/40 to-blue-300/50 border-white/10 text-white"
                : " border-white/10bg-neutral-800/80 text-neutral-400"
            )}
          >
