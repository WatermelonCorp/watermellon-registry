...
export const CommandSearch: FC<Props> = ({
  ...
  useEffect(() => {
    ...
    window.addEventListener("keydown", handleEscape as unknown as EventListener, true);
    return () =>
      window.removeEventListener("keydown", handleEscape as unknown as EventListener, true);
  }, [onClose]);
