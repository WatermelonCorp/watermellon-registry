...
export const SwitchDisclosure: React.FC<SwitchDisclosureProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`w-[340px] bg-white dark:bg-zinc-900 rounded-[35px] p-[5px] overflow-hidden transition-colors duration-300 ${
        isEnabled
          ? "border-[1.5px] border-[#EBEBF0] dark:border-zinc-800"
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className={`p-2 rounded-full transition-colors text-[#ADACB8] dark:text-zinc-500`}
          >
        ...
        <div
          className={`w-12 h-7 rounded-full relative transition-colors duration-300 ${
            isEnabled ? "bg-[#EE2563]" : "bg-gray-200 dark:bg-zinc-700"
          }`}
        >
          <motion.div
            layout
