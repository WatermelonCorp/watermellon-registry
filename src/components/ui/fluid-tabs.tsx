  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-zinc-950 transition-colors duration-500">
      ...
      <button
        ...
        className="mb-12 p-3 rounded-full bg-[#F5F1EB] dark:bg-zinc-900 border border-transparent dark:border-zinc-800 shadow-sm active:scale-90 transition-all"
      >
        {isDark ? (
          <Sun className="text-yellow-400" size={20} />
        ) : (
          <Moon className="text-[#585652]" size={20} />
        )}
      </button>

      <div className="relative flex items-center gap-[8px] px-[4px] py-[4px] bg-[#F5F1EB] dark:bg-zinc-900 border-[1.6px] border-[#f5f1ebf4] dark:border-zinc-800 rounded-full transition-colors">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="relative px-[16px] py-[15px] rounded-full group outline-none"
            >
              ...
              <motion.div
                ...
                className={`relative z-10 flex items-center gap-[12px] transition-colors duration-200
                  ${
                    isActive
