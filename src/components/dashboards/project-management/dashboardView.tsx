...
export const SettingsView = () => {
  ...
  return (
    <div className="w-full h-full px-3 flex flex-col">
      <div className="flex items-end justify-between  border-neutral-200">
        <h1 className="text-3xl text-neutral-700 tracking-tighter">Settings</h1>
        <div className="flex items-center gap-3">
          <div className="relative">
            <Search className="pointer-events-none absolute top-1/2 left-2.5 size-4 -translate-y-1/2 text-neutral-400" />
            <Input
              placeholder="Search"
              className="pl-8 pr-14 h-8 w-56 text-sm bg-white border-neutral-300 placeholder:text-neutral-400"
            />
            <div className="absolute top-1/2 right-2 flex items-center gap-0.5 -translate-y-1/2 text-xs text-neutral-500 bg-neutral-100 py-0.5 px-1.5 rounded">
              <Command className="size-3" />
              <span className="font-medium">F</span>
            </div>
          </div>
          <Select defaultValue="all">
            <SelectTrigger className="w-fit !h-8 text-sm border-neutral-300">
          ...
          <button className="px-2.5 py-2 hover:bg-neutral-100 rounded-md border border-neutral-300 h-8 flex items-center gap-1.5 text-sm text-neutral-500">
      ...
      <Tabs defaultValue="workspace" className="gap-0 mt-5">
        <div className="border-b w-full">
          <TabsList className="bg-transparent p-0 flex gap-6 m-0">
            <TabsTrigger
              value="general"
              className="rounded-none text-neutral-500 data-[state=active]:text-neutral-900 data-[state=active]:border-b-2 data-[state=active]:border-b-neutral-900 data-[state=active]:shadow-none p-0 pb-2 font-normal tracking-tight"
            >
              General Settings
            </TabsTrigger>
            <TabsTrigger
              value="workspace"
              className="rounded-none text-neutral-500 data-[state=active]:text-neutral-900 data-[state=active]:border-b-[1.5px] data-[state=active]:border-b-neutral-900 data-[state=active]:shadow-none p-0 pb-2 font-normal tracking-tight"
            >
              Workspace
            </TabsTrigger>
            <TabsTrigger
        ...
        <TabsContent value="workspace" className="border-0 overflow-y-auto">
          <div className="py-4 space-y-4">
            ...
            <div className="flex gap-8 bg-[#fafaf8] p-3 rounded-md tracking-tight">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xs text-neutral-500 mt-1 max-w-48 leading-tight tracking-tight">
              ...
              <div className="bg-background p-2 flex-1 rounded-md">
                <div className="bg-neutral-50 rounded-lg border">
                  <div className="flex items-center gap-2 bg-background p-2 rounded-t-lg">
                    <Avatar className="size-11 rounded-full bg-white border border-neutral-200">
                      <AvatarFallback className="bg-background rounded-full text-neutral-600 border border-neutral-200">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="m-2 border-neutral-300 text-neutral-400 font-normal"
                  >
            ...
            <div className="flex gap-8 bg-[#fafaf8] p-3 rounded-md tracking-tight">
              ...
              <div className="bg-background p-2 flex-1 rounded-md flex flex-col gap-4">
                <div className="bg-neutral-50 rounded-lg p-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-9 bg-white border-neutral-200 text-neutral-600"
                    />
                  </div>
                </div>
                <div className="bg-neutral-50 rounded-lg p-2">
                  <Label className="text-neutral-700 mb-2">Workspace URL</Label>
                  <div className="relative">
                ...
                <div className="bg-neutral-50 rounded-lg p-2">
                  <Label className="text-neutral-700 mb-2">Industry</Label>
                  <div className="relative">
                ...
                <div className="bg-neutral-50 rounded-lg p-2">
                  ...
                  <Textarea
                    ...
                    className="bg-white border-neutral-200 min-h-[100px] resize-none text-neutral-600"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-8 bg-[#fafaf8] p-3 rounded-md tracking-tight">
              ...
              <div className="bg-background p-2 flex-1 rounded-md flex flex-col gap-4">
                <div className="bg-neutral-50 rounded-lg p-2">
                  ...
                  <div className="relative">
                    ...
                    <Select defaultValue="monday">
                      <SelectTrigger className="pl-9 bg-white border-neutral-200 w-full text-neutral-600">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="bg-neutral-50 rounded-lg p-2">
                  <Label className="text-neutral-700 mb-2">Time Zone</Label>
                  <div className="relative">
        ...
        <TabsContent value="integrations" className="border-0">
          <div className="py-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {integrations.map((integration) => (
                <div
                  key={integration.id}
                  className="bg-white border border-neutral-200 rounded-lg flex flex-col justify-between min-h-[160px] relative"
                >
                  {/* Connected Badge */}
                  {integration.connected && (
                    <div className="absolute top-3 right-3 flex items-center gap-1.5 text-xs text-neutral-500 border border-neutral-200 rounded-full px-2 py-1 bg-neutral-50">
                  ...
                  {/* Action Buttons */}
                  <div className="mt-4 flex gap-2 justify-between bg-[#fafaf8] p-2 rounded-b-lg">
                    {integration.connected ? (
                      <>
                        <Button
                          variant="ghost"
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="border-neutral-300 font-normal px-3 flex-1/2"
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-full border-neutral-300 font-normal"
                      >
                        Connect
                      </Button>
                    )}
          ...
          >
            ...
            >
              <DialogHeader className="px-4 py-2 flex flex-row items-center justify-between border-b border-neutral-200">
              ...
              {selectedIntegration && (
                <div className="p-4">
                  ...
                  <div className="bg-background flex-1 rounded-md flex flex-col gap-4">
                    <div className="bg-neutral-50 rounded-lg p-2">
                      <Label className="text-neutral-900 font-medium mb-2">
                    ...
                    {selectedIntegration.actions &&
                      selectedIntegration.actions.length > 0 && (
                        <div className="bg-neutral-50 rounded-lg p-2">
                          ...
                          <div className="space-y-0 border bg-white border-neutral-50 rounded-lg overflow-hidden">
