          ...
          <SidebarMenu>
            {apps.map((app) => (
                <SidebarMenuItem key={app.name}>
                  <SidebarMenuButton asChild tooltip={app.name} className="text-neutral-500 text-xs h-8 font-medium data-[active=true]:border-neutral-300 hover:border hover:border-neutral-300 data-[active=true]:text-neutral-600 hover:text-neutral-600">
                    <a href={app.url}>
                      <app.icon />
